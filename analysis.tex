...
\usepackage[defaultcolor=OliveGreen]{changes}
\ifLuaTeX
...
\hypersetup{
  pdftitle={No Deal: German Researchers' Publishing and Citing Behaviours},
  pdflang={en-GB},
  colorlinks=true,
  linkcolor={black},
  filecolor={Maroon},
...
\tightlist
\item
  Did \added{contract negotiations with Elsevier and} restricted access to Elsevier journals at DEAL institutions result in a change in researchers' publishing behaviour?
\item
  Did \added{contract negotiations with Elsevier and} restricted access to Elsevier journals at DEAL institutions result in a change in researchers' citing behaviour?
\end{enumerate}
